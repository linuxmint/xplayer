...
G_DEFINE_TYPE(XplayerAspectFrame, xplayer_aspect_frame, CLUTTER_TYPE_ACTOR)

#define ASPECT_FRAME_PRIVATE(o)                                                \
  (G_TYPE_INSTANCE_GET_PRIVATE((o), XPLAYER_TYPE_ASPECT_FRAME,                 \
                               XplayerAspectFramePrivate))
...
struct _XplayerAspectFramePrivate {
  guint expand : 1;
  gdouble rotation;
};

static void xplayer_aspect_frame_get_property(GObject *object,
                                              guint property_id, GValue *value,
                                              GParamSpec *pspec) {
  XplayerAspectFrame *frame = XPLAYER_ASPECT_FRAME(object);

  switch (property_id) {
  case PROP_EXPAND:
    g_value_set_boolean(value, xplayer_aspect_frame_get_expand(frame));
    break;
...
static void xplayer_aspect_frame_set_property(GObject *object,
                                              guint property_id,
                                              const GValue *value,
                                              GParamSpec *pspec) {
  if (property_id == PROP_EXPAND) {
    xplayer_aspect_frame_set_expand(XPLAYER_ASPECT_FRAME(object),
...
static void xplayer_aspect_frame_dispose(GObject *object) {
  G_OBJECT_CLASS(xplayer_aspect_frame_parent_class)->dispose(object);
}

static void xplayer_aspect_frame_finalize(GObject *object) {
  G_OBJECT_CLASS(xplayer_aspect_frame_parent_class)->finalize(object);
}

static void xplayer_aspect_frame_get_preferred_width(ClutterActor *actor,
                                                     gfloat for_height,
                                                     gfloat *min_width_p,
                                                     gfloat *nat_width_p) {
  gboolean override;
  ...
  CLUTTER_ACTOR_CLASS(xplayer_aspect_frame_parent_class)
      ->get_preferred_width(actor, for_height, min_width_p, nat_width_p);
}

static void xplayer_aspect_frame_get_preferred_height(ClutterActor *actor,
                                                      gfloat for_width,
                                                      gfloat *min_height_p,
                                                      gfloat *nat_height_p) {
  gboolean override;
...
static void xplayer_aspect_frame_get_size(XplayerAspectFrame *frame,
                                          gdouble rotation, gfloat *width,
                                          gfloat *height) {
  ClutterActorBox box;
  gfloat w, h;
...
static void _get_allocation(ClutterActor *actor, gfloat *width,
                            gfloat *height) {
  ClutterActorBox box;
...
static void
xplayer_aspect_frame_set_rotation_internal(XplayerAspectFrame *frame,
                                           gdouble rotation, gboolean animate) {
  XplayerAspectFramePrivate *priv = frame->priv;
  ClutterActor *actor;
  ...
  xplayer_aspect_frame_get_size(frame, rotation, &frame_width, &frame_height);
  ...
  clutter_actor_set_scale(actor, child_dest_width / child_width,
...
static void xplayer_aspect_frame_allocate(ClutterActor *actor,
  ...
  XplayerAspectFramePrivate *priv = XPLAYER_ASPECT_FRAME(actor)->priv;
  ...
  xplayer_aspect_frame_set_rotation_internal(XPLAYER_ASPECT_FRAME(actor),
                                             priv->rotation, FALSE);
}

static void xplayer_aspect_frame_paint(ClutterActor *actor) {
  ClutterActor *child;
  XplayerAspectFramePrivate *priv = XPLAYER_ASPECT_FRAME(actor)->priv;
...
static void xplayer_aspect_frame_pick(ClutterActor *actor,
...
static void xplayer_aspect_frame_class_init(XplayerAspectFrameClass *klass) {
  GParamSpec *pspec;

  GObjectClass *object_class = G_OBJECT_CLASS(klass);
  ClutterActorClass *actor_class = CLUTTER_ACTOR_CLASS(klass);

  g_type_class_add_private(klass, sizeof(XplayerAspectFramePrivate));

  object_class->get_property = xplayer_aspect_frame_get_property;
  object_class->set_property = xplayer_aspect_frame_set_property;
  object_class->dispose = xplayer_aspect_frame_dispose;
  object_class->finalize = xplayer_aspect_frame_finalize;

  actor_class->get_preferred_width = xplayer_aspect_frame_get_preferred_width;
  actor_class->get_preferred_height = xplayer_aspect_frame_get_preferred_height;
  actor_class->allocate = xplayer_aspect_frame_allocate;
  actor_class->paint = xplayer_aspect_frame_paint;
  actor_class->pick = xplayer_aspect_frame_pick;
...
static void xplayer_aspect_frame_init(XplayerAspectFrame *self) {
...
ClutterActor *xplayer_aspect_frame_new(void) {
  return g_object_new(XPLAYER_TYPE_ASPECT_FRAME, NULL);
}
...
void xplayer_aspect_frame_set_expand(XplayerAspectFrame *frame,
  ...
  if (priv->expand != expand) {
    ...
    xplayer_aspect_frame_set_rotation_internal(frame, priv->rotation, TRUE);
  }
}

gboolean xplayer_aspect_frame_get_expand(XplayerAspectFrame *frame) {
  g_return_val_if_fail(XPLAYER_IS_ASPECT_FRAME(frame), FALSE);
...
void xplayer_aspect_frame_set_rotation(XplayerAspectFrame *frame,
  ...
  if (rotation == 0.0 && frame->priv->rotation == 270.0)
    ...
    xplayer_aspect_frame_set_rotation_internal(frame, 0.0, FALSE);
  else if (rotation == 270.0 && fmod(frame->priv->rotation, 360.0) == 0.0)
    xplayer_aspect_frame_set_rotation_internal(frame, 360.0, FALSE);
...
void xplayer_aspect_frame_set_internal_rotation(XplayerAspectFrame *frame,
                                                gdouble rotation) {
  g_return_if_fail(XPLAYER_IS_ASPECT_FRAME(frame));
...
gdouble xplayer_aspect_frame_get_rotation(XplayerAspectFrame *frame) {
  ...
  g_return_val_if_fail(XPLAYER_IS_ASPECT_FRAME(frame), 0.0);
