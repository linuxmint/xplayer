/* xplayer-rotation-plugin.c generated by valac 0.22.0, the Vala compiler
 * generated from xplayer-rotation-plugin.vala, do not modify */
...
#define GIO_ROTATION_FILE_ATTRIBUTE "metadata::xplayer::rotation"
...
static void _rotation_plugin_cb_file_closed_xplayer_object_file_closed (XplayerObject* _sender, gpointer self);
static void rotation_plugin_cb_file_opened (RotationPlugin* self, const gchar* mrl);
static void _rotation_plugin_cb_file_opened_xplayer_object_file_opened (XplayerObject* _sender, const gchar* mrl, gpointer self);
...
static void rotation_plugin_real_activate (PeasActivatable* base) {
	...
	XplayerObject* _tmp32_ = NULL;
	XplayerObject* _tmp33_ = NULL;
	self = (RotationPlugin*) base;
	g_object_get ((PeasActivatable*) self, "object", &_tmp0_, NULL);
	_tmp1_ = _tmp0_;
	t = G_TYPE_CHECK_INSTANCE_CAST (_tmp1_, xplayer_object_get_type (), XplayerObject);
	_tmp2_ = t;
	_tmp3_ = xplayer_object_get_current_mrl (_tmp2_);
	mrl = _tmp3_;
	_tmp4_ = t;
	_tmp5_ = xplayer_object_get_video_widget (_tmp4_);
	...
	_tmp7_ = t;
	_tmp8_ = xplayer_object_get_ui_manager (_tmp7_);
	ui_manager = _tmp8_;
	_tmp9_ = ui_manager;
	...
	_tmp32_ = t;
	g_signal_connect_object (_tmp32_, "file-closed", (GCallback) _rotation_plugin_cb_file_closed_xplayer_object_file_closed, self, 0);
	_tmp33_ = t;
	g_signal_connect_object (_tmp33_, "file-opened", (GCallback) _rotation_plugin_cb_file_opened_xplayer_object_file_opened, self, 0);
...
static void rotation_plugin_real_deactivate (PeasActivatable* base) {
	...
	_tmp1_ = _tmp0_;
	t = G_TYPE_CHECK_INSTANCE_CAST (_tmp1_, xplayer_object_get_type (), XplayerObject);
	g_signal_parse_name ("file-closed", xplayer_object_get_type (), &_tmp2_, NULL, FALSE);
	g_signal_handlers_disconnect_matched (t, G_SIGNAL_MATCH_ID | G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA, _tmp2_, 0, NULL, (GCallback) _rotation_plugin_cb_file_closed_xplayer_object_file_closed, self);
	g_signal_parse_name ("file-opened", xplayer_object_get_type (), &_tmp3_, NULL, FALSE);
	g_signal_handlers_disconnect_matched (t, G_SIGNAL_MATCH_ID | G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA, _tmp3_, 0, NULL, (GCallback) _rotation_plugin_cb_file_opened_xplayer_object_file_opened, self);
	_tmp4_ = xplayer_object_get_ui_manager (t);
	ui_manager = _tmp4_;
...
static gboolean rotation_plugin_store_state_co (RotationPluginStoreStateData* _data_) {
	...
	_data_->t = G_TYPE_CHECK_INSTANCE_CAST (_data_->_tmp1_, xplayer_object_get_type (), XplayerObject);
	_data_->_tmp2_ = NULL;
	_data_->_tmp2_ = _data_->t;
	_data_->_tmp3_ = NULL;
	_data_->_tmp3_ = xplayer_object_get_current_mrl (_data_->_tmp2_);
	...
	__catch0_g_error:
	{
		...
		g_warning ("xplayer-rotation-plugin.vala:145: Could not store file attribute: %s", _data_->_tmp20_);
...
static gboolean rotation_plugin_try_restore_state_co (RotationPluginTryRestoreStateData* _data_) {
	...
	__catch1_g_error:
	{
		...
		g_warning ("xplayer-rotation-plugin.vala:163: Could not query file attribute: %s", _data_->_tmp19_);
		_g_error_free0 (_data_->e);
	}
	__finally1:
	if (_data_->_inner_error_ != NULL) {
