 ...
 *
 * Registers a plugin with the Xplayer plugin system, including registering the type specified in the parameters and declaring its activate and
 * deactivate functions.
 **/
#define _XPLAYER_PLUGIN_REGISTER(TYPE_NAME, TypeName, type_name, TYPE_CODE, REGISTER_CODE)	\
	typedef struct {							\
 ...
 * deactivate functions.
 **/
#define XPLAYER_PLUGIN_REGISTER(TYPE_NAME, TypeName, type_name)			\
	_XPLAYER_PLUGIN_REGISTER(TYPE_NAME, TypeName, type_name,,)

/**
 * XPLAYER_PLUGIN_REGISTER_CONFIGURABLE:
 * @TYPE_NAME: the name of the plugin type, in UPPER_CASE
 * @TypeName: the name of the plugin type, in CamelCase
 * @type_name: the name of the plugin type, in lower_case
 *
 * Registers a configurable plugin with the Xplayer plugin system, including registering the type specified in the parameters and declaring its activate
 * and deactivate and widget creation functions.
 **/
#define XPLAYER_PLUGIN_REGISTER_CONFIGURABLE(TYPE_NAME, TypeName, type_name)	\
