...
#define EGG_SM_CLIENT_WIN32(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), EGG_TYPE_SM_CLIENT_WIN32,                 \
                              EggSMClientWin32))
#define EGG_SM_CLIENT_WIN32_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_CAST((klass), EGG_TYPE_SM_CLIENT_WIN32,                  \
                           EggSMClientWin32Class))
#define EGG_IS_SM_CLIENT_WIN32(obj)                                            \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), EGG_TYPE_SM_CLIENT_WIN32))
#define EGG_IS_SM_CLIENT_WIN32_CLASS(klass)                                    \
  (G_TYPE_CHECK_CLASS_TYPE((klass), EGG_TYPE_SM_CLIENT_WIN32))
#define EGG_SM_CLIENT_WIN32_GET_CLASS(obj)                                     \
  (G_TYPE_INSTANCE_GET_CLASS((obj), EGG_TYPE_SM_CLIENT_WIN32,                  \
                             EggSMClientWin32Class))
...
static void sm_client_win32_startup(EggSMClient *client, const char *client_id);
static void sm_client_win32_will_quit(EggSMClient *client, gboolean will_quit);
...
static void egg_sm_client_win32_init(EggSMClientWin32 *win32) { ; }

static void egg_sm_client_win32_class_init(EggSMClientWin32Class *klass) {
...
static gboolean emit_quit_requested(gpointer smclient) {
  gdk_threads_enter();
...
static gboolean emit_quit(gpointer smclient) {
...
static gboolean emit_quit_cancelled(gpointer smclient) {
  EggSMClientWin32 *win32 = smclient;
...
static gboolean got_message(gpointer smclient) {
  EggSMClientWin32 *win32 = smclient;
...
static gboolean g_win32_handle_source_prepare(GSource *source, gint *timeout) {
  *timeout = -1;
  return FALSE;
}
...
static gboolean g_win32_handle_source_dispatch(GSource *source,
...
GSourceFuncs g_win32_handle_source_funcs = {
    g_win32_handle_source_prepare, g_win32_handle_source_check,
    g_win32_handle_source_dispatch, g_win32_handle_source_finalize};
...
static GSource *g_win32_handle_source_add(HANDLE handle, GSourceFunc callback,
  ...
  source =
      g_source_new(&g_win32_handle_source_funcs, sizeof(GWin32HandleSource));
...
LRESULT CALLBACK sm_client_win32_window_procedure(HWND hwnd, UINT message,
                                                  WPARAM wParam,
                                                  LPARAM lParam) {
...
static void sm_client_thread(gpointer smclient) {
  HINSTANCE instance;
  WNDCLASSEXW wcl;
  ATOM klass;
  HWND window;
  ...
  window =
      CreateWindowEx(0, MAKEINTRESOURCE(klass), L"EggSmClientWindow", 0, 10, 10,
                     50, 50, GetDesktopWindow(), NULL, instance, NULL);
